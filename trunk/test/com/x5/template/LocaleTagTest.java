...
public class LocaleTagTest
{
    ...
    public void testRemoveClutter()
    {
        ...
        Chunk c = new Chunk();
        c.append("Bla bla bla &[A new car!] bla bla");
    ...
    public void testFmtStringStatic()
    {
        ...
        Chunk c = new Chunk();
        c.append("Bla bla bla {&[A new %s car!],blue} bla bla");
    ...
    public void testArg()
    {
        ...
        Chunk c = new Chunk();
        c.set("color", "blue");
        c.append("Bla bla bla {&[A new %s car!],~color} bla bla");
        assertEquals("Bla bla bla A new blue car! bla bla", c.toString());
    }
    ...
    public void testManyArgs()
    {
        ...
        c.set("color", "blue");
        c.set("make", "lexus");
        c.append("Bla bla bla {&[A new %s %s!],~color,~make} bla bla");
    ...
    public void testMoreThanOne()
    {
        ...
        // even if no translation locale is provided
        Chunk c = new Chunk();
        c.append("Bla bla bla &[A new car!] bla &[A new house!] bla");
    ...
    public void testMoreThanOneMixed()
    {
        ...
        Chunk c = new Chunk();
        c.append("Bla bla bla {&[A new car!]} bla &[A new house!] bla. ");
        c.append("Bla bla bla {&[A new pet!]} bla &[A new life!] bla");
    ...
    public void testMismatchedArgs()
    {
        ...
        c.append("Bla bla bla {&[A new %s %s!],~color} bla bla");
